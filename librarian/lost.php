			   ...
			   <div class="alert alert-info">
						...
						<h1>Lost Books</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_books.php" class="btn btn-success">Add Books</a></p>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'lost'")or die(mysql_error());
                                    ...
                                    <td class="action">
                                        <a rel="tooltip"  title="Delete" id="<?php echo $id; ?>" href="#delete_book<?php echo $id; ?>" data-toggle="modal"    class="btn btn-danger"><span><img src="../LMS/del.png" style="width: 20px; height= 20px; "></span></a>
                                        <?php include('delete_book_modal.php'); ?>
										<a  rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="edit_book.php<?php echo '?id='.$id; ?>" class="btn btn-success"><span><img src="../LMS/edit.png" style="width: 20px; height= 20px; "></span></a>
