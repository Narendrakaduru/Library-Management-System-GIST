...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		...
		?>
             <div class="alert alert-info">Edit Member</div>
			<p><a class="btn btn-info" href="member.php">Back</a></p>
	...
	<form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
         ...
         <div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputEmail" name="student_id" value="<?php echo $row['student_id']; ?>" placeholder="Student ID" required>
